...
class UploadServiceTest {
  ...
  class InitiateMultipart {
              ...
              inv -> {
                ...
                s =
                    UploadSession.builder()
                        ...
                        .status(com.vaultflow.upload.domain.enums.UploadStatus.INITIATED)
                        .build();
                return s;
              });
    ...
    void bucketNotFound() {
      ...
      InitiateUploadRequest request =
          new InitiateUploadRequest(bucketId, "test.txt", "text/plain", null, null);
    ...
    void abortsCleanly() {
      ...
      UploadSession session =
          UploadSession.builder()
              ...
              .initiatedBy(userId)
              .contentType("application/octet-stream")
              .status(com.vaultflow.upload.domain.enums.UploadStatus.UPLOADING)
              .build();
